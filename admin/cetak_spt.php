...
if (empty($d['id_spt'])) {
    echo "<script>alert('Data SPT belum dibuat! Silakan input data terlebih dahulu.'); window.location.href='spt_tugas.php?id=$id_kunjungan';</script>";
    exit;
}
...
<head>
    ...
    <style>
        ...
        .teks-kop h1, .teks-kop h2, .teks-kop h3, .teks-kop p {
            margin: 0;
            padding: 0;
        }
        .teks-kop h1 { font-size: 16pt; font-weight: normal; }
        .teks-kop h2 { font-size: 18pt; font-weight: bold; letter-spacing: 1px; }
        ...
        @media print { 
            ...
            .kertas-a4 { margin: 0; box-shadow: none; padding: 0; }
...
<body>
    ...
    <div class="kertas-a4">
        ...
        <div class="isi-surat">
            ...
            <table class="tabel-pegawai">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?= $d['jumlah_ditugaskan']; ?> Orang</td>
                </tr>
            </table>
            ...
            <table class="tabel-tujuan">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?= tgl_indo($d['tgl_kunjungan']); ?> (<?= substr($d['waktu_kunjungan'], 0, 5); ?> WITA)</td>
                </tr>
            </table>
        ...
        <div class="ttd-area">
            ...
            <p><strong>Sekretaris DPRD Kota Banjarmasin</strong></p>
