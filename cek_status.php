                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <form method="POST" action="">
                            <div class="input-group mb-3">
                                <input type="text" name="kode_booking" class="form-control form-control-lg text-center"
                                    placeholder="Contoh: REQ-2025-X7A2"
                                    value="<?= isset($_POST['kode_booking']) ? $_POST['kode_booking'] : '' ?>"
                                    required>
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center 
                        <?php
                            if ($data['status_kegiatan'] == 'pending') {
                                echo 'bg-warning';
                            } elseif ($data['status_kegiatan'] == 'dijadwalkan') {
                                echo 'bg-primary';
                            } elseif ($data['status_kegiatan'] == 'selesai') {
                                echo 'bg-success';
                            } else {
                                echo 'bg-danger';
                            }
?> text-white">
                        <h5 class="mb-0 text-white">Status:
                            <?= strtoupper($data['status_kegiatan']); ?>
                        </h5>
                        <span
                            class="badge bg-white text-dark"><?= $data['kode_booking']; ?></span>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <a href="cetak_tiket.php?kode=<?= $data['kode_booking']; ?>"
                                target="_blank" class="btn btn-outline-dark mt-2 btn-sm">
                        ...
                        <div class="alert alert-primary mt-3">
                            <h6 class="alert-heading fw-bold"><i class="ti ti-info-circle me-1"></i> Informasi
                                Pelaksanaan</h6>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
