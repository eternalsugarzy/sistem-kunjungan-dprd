                        ...
                        <form method="POST" action="">
                            <div class="input-group mb-3">
                                <input type="text" name="kode_booking"
                                    class="form-control form-control-lg text-center border-dark" placeholder="REQ-..."
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card shadow border-dark">
                        ...
                        if ($status_kunjungan == 'pending')
                            echo 'bg-warning';
                        elseif ($status_kunjungan == 'dijadwalkan')
                            echo 'bg-primary';
                        elseif ($status_kunjungan == 'sedang berkunjung')
                            echo 'bg-info';
                        elseif ($status_kunjungan == 'selesai')
                            echo 'bg-success';
                        else
                            echo 'bg-danger';
                        ?> text-dark border-bottom border-dark">
                            ...
                            <h5
                                class="mb-0 fw-bold <?php if (in_array($status_kunjungan, ['dijadwalkan', 'sedang berkunjung', 'batal']))
                                    echo 'text-white'; ?>">
                                Status: <?= strtoupper(str_replace('_', ' ', $status_kunjungan)); ?>
                            </h5>
                            <span
                                class="badge bg-white text-dark border border-dark f-14 px-3 py-2"><?= htmlspecialchars($data['kode_booking']); ?></span>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <?php if ($status_kunjungan == 'pending'): ?>
                                    ...
                                    <p class="text-muted">Mohon menunggu, admin sedang mengecek ketersediaan jadwal pejabat dan
                                        ruangan.</p>

                                <?php elseif ($status_kunjungan == 'dijadwalkan'): ?>
                                    <h3 class="mt-2 fw-bold text-success"><i class="ti ti-circle-check me-2"></i>Kunjungan
                                        Disetujui!</h3>
                                    <p class="text-muted mb-3">Tunjukkan E-Ticket QR Code ini kepada petugas Keamanan saat
                                        kedatangan.</p>
                                    ...
                                    <br>
                                    <a href="cetak_tiket.php?kode=<?= $data['kode_booking']; ?>" target="_blank"
                                        class="btn btn-dark mt-2 btn-sm px-3">
                                ...
                                <?php elseif ($status_kunjungan == 'sedang berkunjung'): ?>
                                    ...
                                    <p class="text-muted mb-3">Selamat datang di DPRD. Harap simpan E-Ticket ini untuk melakukan
                                        <b>Check-Out</b> saat kepulangan nanti.</p>
                                ...
                                <?php elseif ($status_kunjungan == 'selesai'): ?>
                                    ...
                                    <p class="text-muted">Terima kasih atas kunjungan Anda. Silakan berikan penilaian terhadap
                                        pelayanan kami.</p>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="mb-0 h6">
                                        ...
                                        <span class="badge bg-dark ms-1"><?= substr($data['waktu_kunjungan'], 0, 5); ?>
                                            WITA</span>
                                    </p>
                                </div>
                                <div class="col-md-12">
                                    <small class="text-muted fw-bold">Tujuan / Materi</small>
                                    <p class="mb-0 border p-2 bg-light rounded text-dark">
                                        <?= nl2br(htmlspecialchars($data['materi_kunjungan'])); ?></p>
                                </div>
                            </div>

                            <?php if (in_array($status_kunjungan, ['dijadwalkan', 'sedang berkunjung', 'selesai'])): ?>
                                <h6 class="fw-bold bg-light p-2 border-start border-4 border-dark">[ Informasi Pelaksanaan ]
                                </h6>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <small class="text-muted fw-bold">Lokasi Ruangan:</small><br>
                                        <span
                                            class="h6"><?= !empty($data['nama_ruangan']) ? htmlspecialchars($data['nama_ruangan']) : 'Belum ditentukan'; ?></span>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <small class="text-muted fw-bold">Penerima Tamu (PJ):</small><br>
                                        <span
                                            class="h6"><?= !empty($data['nama_pj']) ? htmlspecialchars($data['nama_pj']) : 'Sekretariat DPRD'; ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                        ...
                        <div
                            class="card-footer bg-white border-top border-dark text-center p-3 d-flex justify-content-center gap-2">

                            <?php if (in_array($status_kunjungan, ['pending', 'dijadwalkan'])): ?>
                                <a href="batal_kunjungan.php?id=<?= $data['id_kunjungan']; ?>" class="btn btn-danger">Batalkan Kunjungan</a>
                            <?php endif; ?>
